...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-sandpaper-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-sandpaper-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-sandpaper
# for installing globally
pixi global install r-sandpaper
```
...
It is possible to list all of the versions of `r-sandpaper` available on your platform:
...
```
pixi search r-sandpaper --channel conda-forge
```
